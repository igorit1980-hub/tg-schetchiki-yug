...
Сделать Telegram Mini App для проекта `Счетчики Юг` не локальным прототипом, а полноценным онлайн-приложением:
...
- показ оптовых цен после подтверждения;
...
- после подтверждения клиент видит оптовые цены.
